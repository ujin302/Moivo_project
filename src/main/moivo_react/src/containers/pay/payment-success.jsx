    ...
    try {
      const response = await axiosInstance.post(
        '/api/user/payment', 
        {
          ...
          paymentDetail: JSON.stringify(paymentDetailList),
          isCartItem: isCartItem,
        }
      );
  
      console.log("결제 내역: ", payment);
      console.log("결제 상세: ", paymentDetailList);
      console.log("장바구니 여부: ", isCartItem);
      console.log("토스 코드: ", payment.tosscode);
